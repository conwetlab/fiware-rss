...
public class DbeExpendControlDaoImpl extends GenericDaoImpl<DbeExpendControl, DbeExpendLimitPK> implements
     ...
     * 
     * @see
     * es.upm.greta.dbe.expenditureLimit.dao.DbeExpendControlDao#getExpendDataForUserAppProvCurrencyObCountry(java.lang
     ...
     * 
     * @see
     * es.upm.greta.dbe.expenditureLimit.dao.DbeExpendControlDao#saveDbeExpendControl(es.upm.greta.dbe.expenditureLimit
