...
public class ServDeployMopDaoImpl extends GenericDaoImpl<BmServdeployMop, Long> implements ServDeployMopDao {
     ...
     * (non-Javadoc)
     * 
     * @see es.tid.greta.bmms.dao.ServDeployMopDao
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see es.tid.greta.bmms.dao.ServDeployMopDao#listServDeployMopsbyDeploymentId(long)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see es.tid.greta.bmms.dao.ServDeployMopDao#getServiceDeployMop(long, long)
     */
    @Override
