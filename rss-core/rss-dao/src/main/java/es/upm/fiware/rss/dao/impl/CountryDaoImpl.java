...
import es.upm.fiware.rss.dao.CountryDao;
...
public class CountryDaoImpl extends GenericDaoImpl<BmCountry, Long> implements CountryDao {
     ...
     * (non-Javadoc)
     * 
     * @see es.upm.greta.bmms.dao.CountryDao#getByIso3166Code(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see es.upm.greta.bmms.dao.CountryDao#getByItuT212Code(java.lang.String)
     */
    @Override
